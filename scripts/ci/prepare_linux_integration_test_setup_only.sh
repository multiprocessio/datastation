...
curl -LO https://github.com/mongodb-js/mongosh/releases/download/v1.1.9/mongodb-mongosh_1.5.0_amd64.deb
sudo apt-get install -y ./mongodb-mongosh_1.5.0_amd64.deb
