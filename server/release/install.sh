...
sudo cp "$ROOT_DIR/config.json" /etc/datastation/
sudo cp "$ROOT_DIR/datastation.service" /etc/systemd/system/
sudo cp "$ROOT_DIR/datastation-exporter.timer" /etc/systemd/system/
